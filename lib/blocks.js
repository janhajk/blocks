...
var remove = function(properties, cb) {
      Block.findOneAndRemove(properties._id, function(e, block) {
            utils.log('Removed Block from Database...');
            if (e) return cb(e);
            Block.findByIdAndUpdate(block.parent, { $pull: { children: new mongoose.Types.ObjectId(properties._id) } }, function(e, block) {
                  if (e) return cb(e);
