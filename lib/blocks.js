...
var addChildToParent = function(parentId, childId, cb) {
      Block.findByIdAndUpdate(parentId, {
            // children are ordered in reverse; this is for simplicity when loading in javascript DOM
            $push: {
                  children: {
                        $each: [new mongoose.Types.ObjectId(childId)],
                        $position: 0
                  }
            }
      }, function(e, block) {
